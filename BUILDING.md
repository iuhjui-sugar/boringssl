...
BoringSSL's build system has some support for adding a custom prefix to all
...
It is the caller's responsibility to create and maintain the list of symbols to
be prefixed.
