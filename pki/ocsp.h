...
bool ParseOCSPCertID(const der::Input& raw_tlv,
                                        OCSPCertID* out);
...
// On failure |out| has an undefined state. Some of its fields may have been
// updated during parsing, whereas others may not have been changed.
bool ParseOCSPResponseData(const der::Input& raw_tlv,
...
// On failure |out| has an undefined state. Some of its fields may have been
// updated during parsing, whereas others may not have been changed.
bool ParseOCSPResponse(const der::Input& raw_tlv,
                                          OCSPResponse* out);
...
[[nodiscard]] OCSPRevocationStatus
