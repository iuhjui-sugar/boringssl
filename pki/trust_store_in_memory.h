...
class OPENSSL_EXPORT TrustStoreInMemory : public TrustStore {
 public:
  ...
  // Distrust the provided SPKI. This will override any other trust (e.g. if a
  ...
  void AddDistrustedCertificateBySPKI(const std::string spki);
 ...
 private:
  ...
  std::unordered_set<std::string> distrusted_spkis_;
