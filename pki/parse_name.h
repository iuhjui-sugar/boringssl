...
[[nodiscard]] bool ReadRdn(der::Parser* parser,
...
[[nodiscard]] bool ParseName(const der::Input& name_tlv,
                                        RDNSequence* out);
...
[[nodiscard]] bool ParseNameValue(const der::Input& name_value,
                                             RDNSequence* out);
...
// successful.
[[nodiscard]] bool ConvertToRFC2253(const RDNSequence& rdn_sequence,
                                               std::string* out);
}  // namespace net
