...
// |IsPublicKeyAcceptable| will cause any path builder using the delegate
// to add a High severity error of kUnacceptablePublicKey when false is
// returned. No high severity error will be added for true returns.
