...
class OPENSSL_EXPORT VerifyCertificateChainDelegate {
 public:
  ...
  // purpose of validating issued PreCertificates in a path. This should never
  // return true for TLS certificate validation. If this function returns true
  // the CT precertificate poison extension will not prevent the certificate
