...
[[nodiscard]] bool VerifySerialNumber(const der::Input& value,
                                                 bool warnings_only,
                                                 CertErrors* errors);
...
[[nodiscard]] bool ReadUTCOrGeneralizedTime(
    der::Parser* parser,
...
[[nodiscard]] bool ParseValidity(const der::Input& validity_tlv,
...
[[nodiscard]] bool ParseCertificate(
...
//            }
[[nodiscard]] bool ParseTbsCertificate(
...
// On failure |out| has an undefined state. Some of its fields may have been
// updated during parsing, whereas others may not have been changed.
[[nodiscard]] bool ParseExtension(const der::Input& extension_tlv,
                                             ParsedExtension* out);
...
[[nodiscard]] bool ParseExtensions(
...
[[nodiscard]] bool ConsumeExtension(
    const der::Input& oid,
...
// into a uint8_t.
[[nodiscard]] bool ParseBasicConstraints(
...
[[nodiscard]] bool ParseKeyUsage(const der::Input& key_usage_tlv,
...
[[nodiscard]] bool ParseAuthorityInfoAccess(
...
// ignored.
[[nodiscard]] bool ParseAuthorityInfoAccessURIs(
    const der::Input& authority_info_access_tlv,
...
[[nodiscard]] bool ParseCrlDistributionPoints(
...
struct ParsedAuthorityKeyIdentifier {
...
// not guaranteed.
[[nodiscard]] bool ParseAuthorityKeyIdentifier(
...
[[nodiscard]] bool ParseSubjectKeyIdentifier(
    const der::Input& extension_value,
