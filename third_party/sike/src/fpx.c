...
void mp_dblsubx2_asm(const felm_t a, const felm_t b, felm_t c);
crypto_word_t mp_subx2_asm(const felm_t a, const felm_t b, felm_t c);
void mp_add_asm(const felm_t a, const felm_t b, felm_t c);
...
void fp2mul_mont(const f2elm_t a, const f2elm_t b, f2elm_t c) {
    ...
    mp_mul(a->c0, b->c0, tt1);                         // tt1 = a0*b0
    mp_mul(a->c1, b->c1, tt2);                         // tt2 = a1*b1
