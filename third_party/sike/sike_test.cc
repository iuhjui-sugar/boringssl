...
// Additional tests for checking if MUL and REDC handles
// carry chains correctly.
TEST(SIKE, CarryChains) {
  const uint64_t in14[NWORDS_FIELD * 2] = {
  ...
  uint64_t in7[NWORDS_FIELD] = {0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                                0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                                0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                                0xFFFFFFFFFFFFFFFF};

  const uint64_t exp_mul[NWORDS_FIELD * 2] = {
