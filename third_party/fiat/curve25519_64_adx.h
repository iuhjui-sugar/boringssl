...
void fiat_curve25519_adx_mul(fe4, const fe4, const fe4);
void fiat_curve25519_adx_square(fe4, const fe4);
...
// NOTE: edited after generation
  unsigned long long t;
  *out2 = _addcarryx_u64(arg1, arg2, arg3, &t);
  *out1 = t;
}
...
static void fe4_scmul(uint64_t out1[4], const uint64_t arg1[4], uint64_t arg2) {
  ...
  fiat_addcarryx_u64(&x19, &x20, x18, x5, x16);
  ...
  fiat_addcarryx_u64(&x28, &x29, x27, x19, 0x0);
  fiat_addcarryx_u64(&x30, &x31, x29, x21, 0x0);
  fiat_addcarryx_u64(&x32, &x33, x31, x23, 0x0);
  fiat_cmovznz_u64(&x34, x33, 0x0, UINT8_C(0x26));
  fiat_addcarryx_u64(&x35, &x36, 0x0, x26, x34);
  out1[0] = x35;
  out1[1] = x28;
  out1[2] = x30;
  out1[3] = x32;
...
static void x25519_scalar_mult_adx(uint8_t out[32],
