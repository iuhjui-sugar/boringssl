...
extern void __attribute__((sysv_abi)) fiat_curve25519_adx_mul(fe4, const fe4, const fe4);
extern void __attribute__((sysv_abi)) fiat_curve25519_adx_square(fe4, const fe4);
