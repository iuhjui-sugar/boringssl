 ...
 *   out2: [0x0 ~> 0x1]
 */
// NOTE: edited manually after generation
...
#if defined(__GNUC__) && defined(__has_builtin) && (defined(__builtin_ia32_addcarryx_u64) ||__has_builtin(__builtin_ia32_addcarryx_u64)) // ~15% X25519 speedup
  long long unsigned int t;
  *out2 = __builtin_ia32_addcarryx_u64(arg1, arg2, arg3, &t);
  *out1 = t;
#else
  arg2 += arg1;
  arg1 = arg2 < arg1;
...
static FIAT_25519_FIAT_INLINE void fiat_25519_mulx_u64(uint64_t* out1, uint64_t* out2, uint64_t arg1, uint64_t arg2) {
  ...
  unsigned __int128 big = arg1 * (unsigned __int128)arg2;
  *out1 = big;
  *out2 = big >> 64;
...
#else
#error "fiat_25519_mulx_u64 needs __int128 or ARM64/X64 MSVC"
#endif
}
