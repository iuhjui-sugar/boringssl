...
impl<C: Curve> PrivateKey<C> {
    ...
    pub fn from_private_bytes(private_key_bytes: &[u8]) -> Result<Self, Error> {
        EcKey::try_from_raw_bytes(C::NID, private_key_bytes)
            .map(|eckey| Self {
                eckey,
                marker: PhantomData,
            })
...
impl<C: Curve> PublicKey<C> {
    ...
    pub fn from_affine_coordinates<const AFFINE_COORDINATE_SIZE: usize>(
        ...
        EcKey::try_new_public_key_from_affine_coordinates(C::NID, &x[..], &y[..])
            .map(|eckey| Self {
                eckey,
                marker: PhantomData,
            })
...
impl<C: Curve> TryFrom<&[u8]> for PublicKey<C> {
    ...
    fn try_from(value: &[u8]) -> Result<Self, Error> {
        EcKey::try_new_public_key_from_bytes(C::NID, value)
            .map(|eckey| Self {
                eckey,
                marker: PhantomData,
            })
...
mod tests {
    ...
    fn p521_test_diffie_hellman() {
        ...
        let private_key_bytes: [u8; 66] =
            decode_hex("01939982b529596ce77a94bc6efd03e92c21a849eb4f87b8f619d506efc9bb22e7c61640c90d598f795b64566dc6df43992ae34a1341d458574440a7371f611c7dcd");
        let expected_shared_secret: [u8; 66] =
            decode_hex("01f1e410f2c6262bce6879a3f46dfb7dd11d30eeee9ab49852102e1892201dd10f27266c2cf7cbccc7f6885099043dad80ff57f0df96acf283fb090de53df95f7d87");
    ...
    fn p521_to_private_bytes() {
        let private_key_bytes: [u8; 66] = decode_hex(concat!(
            ...
            "e7c61640c90d598f795b64566dc6df43992ae34a1341d458574440a7371f611c7dcd",
        ));
