...
impl EcKey {
    ...
    #[allow(dead_code)]
    pub(crate) unsafe fn ptr(&self) -> *const bssl_sys::EC_KEY {
        self.ptr
    }

    pub(crate) unsafe fn ptr_mut(&mut self) -> *mut bssl_sys::EC_KEY {
        self.ptr
    }
    ...
    pub(crate) fn to_affine_coordinates(&self) -> (BigNum, BigNum) {
        ...
        let mut bn_x = BigNum::new();
        let mut bn_y = BigNum::new();
    ...
    pub(crate) fn generate(curve_nid: i32) -> Self {
        ...
        let result = unsafe { bssl_sys::EC_KEY_generate_key(eckey.ptr_mut()) };
