...
impl Sha256 {
    ...
    pub fn digest() -> Digest<Self, {Self::OUTPUT_SIZE}> {
...
impl<M: Md, const OUTPUT_SIZE: usize> Digest<M, OUTPUT_SIZE> {
    ...
    fn new() -> Self {
        ...
        let result = unsafe { bssl_sys::EVP_DigestInit(md_ctx_uninit.as_mut_ptr(), M::get_md().as_ptr()) };
