...
use crate::aead::{Aead, AeadError, AeadImpl, AeadType};

// Implementation of AES-128-GCM-SIV.
pub struct Aes128GcmSiv(AeadImpl<16, 12, 16>);

impl Aead<16, 12> for Aes128GcmSiv {
    const TAG_SIZE: usize = 16;

    fn new(key: [u8; 16]) -> Self {
        Self(AeadImpl::new(key, AeadType::Aes128GcmSiv))
    }
...
// Implementation of AES-256-GCM-SIV.
pub struct Aes256GcmSiv(AeadImpl<32, 12, 16>);

impl Aead<32, 12> for Aes256GcmSiv {
    const TAG_SIZE: usize = 16;

    fn new(key: [u8; 32]) -> Self {
        Self(AeadImpl::new(key, AeadType::Aes256GcmSiv))
    }
...
#[cfg(test)]
mod test {
    use crate::aead::aes_gcm_siv::{Aes128GcmSiv, Aes256GcmSiv};
    use crate::aead::Aead;
    ...
    fn aes_256_gcm_siv_tests() {
        ...
        let nonce = decode_hex("030000000000000000000000");
        let aes = Aes256GcmSiv::new(test_key);
        let msg: [u8; 8] = decode_hex("0100000000000000");
        let mut buf = Vec::new();
