...
bool Speed(const std::vector<std::string> &args) {
  ...
  if (!SpeedAEAD(EVP_aead_aes_128_gcm(), "AES-128-GCM", 0) ||
      !SpeedAEAD(EVP_aead_aes_256_gcm(), "AES-256-GCM", 0) ||
      !SpeedAEAD(EVP_aead_chacha20_poly1305(), "ChaCha20-Poly1305", 0) ||
      !SpeedAEAD(EVP_aead_rc4_md5_tls(), "RC4-MD5", 0) ||
      !SpeedAEAD(EVP_aead_aes_128_cbc_sha1_tls(), "AES-128-CBC-SHA1", 11) ||
      !SpeedAEAD(EVP_aead_aes_256_cbc_sha1_tls(), "AES-256-CBC-SHA1", 11) ||
