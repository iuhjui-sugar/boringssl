...
const (
	...
	esniKeysPaddedLengthSupportsWildcards uint16 = 260
)
...
type Config struct {
	...
	// EsniKeys defines a rolling list of esniKeys where the
	// zeroth element is the most recent. With key rotation, we
	// want to be able to receive messages encrypted for the last
	// set of keys.
	EsniKeys      []EsniKeys
	EsniKeyShares map[CurveID]ecdhCurve
