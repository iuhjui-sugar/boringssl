...
type ProtocolBugs struct {
	...
	// IgnoreClientALPSPreferences, if true, causes the server to negotiate ALPS
	// for a protocol even if the client did not support it.
	IgnoreClientALPSPreferences bool
