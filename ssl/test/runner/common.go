...
type ProtocolBugs struct {
	...
	// SendEncryptedClientHello, when non-nil, causes the client to send an
	// encrypted_client_hello extension on the ClientHelloOuter message. When
	// nil, the extension will be omitted.
	SendEncryptedClientHello []byte
