...
type Config struct {
	...
	// TLS13CompatMode, if non-zero, causes TLS 1.3 to be negotiated in a compat
	// mode. A value of 1 negotiates the SH compat mode, while a value of 2
	// negotiates the CCS compat mode.
	TLS13CompatMode int
