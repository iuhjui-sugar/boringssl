...
func wireToVersion(vers uint16, isDTLS bool) (uint16, bool) {
	if isDTLS {
		...
		case VersionSSL30, VersionTLS10, VersionTLS11, VersionTLS12:
			return vers, true
		case tls13Draft23Version, tls13Draft28Version, tls13FinalVersion:
...
func isDraft28(vers uint16) bool {
	return vers == tls13Draft28Version || vers == tls13FinalVersion
}
...
func (c *Config) isSupportedVersion(wireVers uint16, isDTLS bool) (uint16, bool) {
	if (c.TLS13Variant != TLS13Draft23 && wireVers == tls13Draft23Version) ||
		...
		(c.TLS13Variant != TLS13Final && wireVers == tls13FinalVersion) {
		return 0, false
	}
