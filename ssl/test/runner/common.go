...
// TLS 1.3 names the production 'SignatureScheme' to avoid colliding with TLS
// 1.2's SignatureAlgorithm but otherwise refers to them as 'signature
// algorithm' throughout. We match the latter.
...
const (
	...
	signatureRSAPSSSHA256 signatureAlgorithm = 0x0700
	signatureRSAPSSSHA384 signatureAlgorithm = 0x0701
	signatureRSAPSSSHA512 signatureAlgorithm = 0x0702
