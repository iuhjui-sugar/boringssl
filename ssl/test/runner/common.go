...
type ProtocolBugs struct {
	...
	// SendEarlyDataInfo, if non-zero, sends the ticket_early_data_info extension
	// in the NewSessionTicket messagte.
	SendEarlyDataInfo uint32

	// ExpectNoEarlyDataInfo, if true, means that the client will fail upon receipt
	// of the ticket_early_data_info extension.
	ExpectEarlyDataInfo bool
