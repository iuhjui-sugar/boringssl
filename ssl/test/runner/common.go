...
type ProtocolBugs struct {
	...
	// SendCipherSuite, if non-zero, is the cipher suite value server will
	// send in the ServerHello. This does not affect the cipher the server
	// believes it has actually negotiated.
