...
const (
	...
	tls13TypeExperimentVersion = 0x7a12
)

const (
	TLS13Default        = 0
	TLS13Experiment     = 1
	TLS13TypeExperiment = 2
)

var allTLSWireVersions = []uint16{
	tls13DraftVersion,
	tls13ExperimentVersion,
	tls13TypeExperimentVersion,
	VersionTLS12,
	VersionTLS11,
	VersionTLS10,
	VersionSSL30,
...
func (c *Config) isSupportedVersion(wireVers uint16, isDTLS bool) (uint16, bool) {
	if (c.TLS13Variant != TLS13Experiment && wireVers == tls13ExperimentVersion) ||
		(c.TLS13Variant != TLS13TypeExperiment && wireVers == tls13TypeExperimentVersion) ||
