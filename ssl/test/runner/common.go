...
type ProtocolBugs struct {
	...
	// SendIncompatibleSessionTicket, if true, causes the server to send a session
	// ticket with PSK modes that BoringSSL doesn't support.
	SendIncompatibleSessionTicket bool
