...
var (
	...
	externalPSKBinderLabel2        = []byte("ext binder")
	resumptionPSKBinderLabel2      = []byte("res binder")
	earlyTrafficLabel2             = []byte("c e traffic")
	clientHandshakeTrafficLabel2   = []byte("c hs traffic")
	serverHandshakeTrafficLabel2   = []byte("s hs traffic")
	clientApplicationTrafficLabel2 = []byte("c ap traffic")
	serverApplicationTrafficLabel2 = []byte("s ap traffic")
	applicationTrafficLabel2       = []byte("traffic upd")
	exporterLabel2                 = []byte("exp master")
	resumptionLabel2               = []byte("res master")
...
func updateTrafficSecret(hash crypto.Hash, version uint16, secret []byte) []byte {
	...
	if isDraft21(version) {
		trafficLabel = applicationTrafficLabel2
	}
