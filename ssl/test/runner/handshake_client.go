...
NextCipherSuite:
	...
	// which determines the version and transcript hash.
...
func (hs *clientHandshakeState) doTLS13Handshake(msg interface{}) error {
	...
	helloRetryRequest, _ := msg.(*helloRetryRequestMsg)
	if helloRetryRequest != nil {
	...
	if helloRetryRequest != nil && helloRetryRequest.hasSelectedGroup && helloRetryRequest.selectedGroup != hs.serverHello.keyShare.group {
		c.sendAlert(alertHandshakeFailure)
