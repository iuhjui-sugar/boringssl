...
// nil, this is a ClientHelloOuter that should contain an encrypted
// |innerHello| which |echEnc| as the encapsulated public key. Otherwise, the
// ClientHello should reflect the connection's true preferences.
...
NextCipherSuite:
	...
	// clients from offering PSKs ClientHelloOuter, but we still need to test
