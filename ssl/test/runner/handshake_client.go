...
NextCipherSuite:
	...
	if len(c.config.ClientECHConfigs) > 0 {
		innerHello, echHPKEContext, err = c.insertECH(hello, nil)
		if err != nil {
			return err
		}
	...
	if haveHelloRetryRequest {
		...
		if innerHello != nil {
			secondInnerHello, _, err = c.insertECH(hello, echHPKEContext)
			if err != nil {
				return err
			}
		}
...
func (c *Conn) insertECH(hello *clientHelloMsg, ctx *hpke.Context) (innerHelloPtr *clientHelloMsg, ctxOut *hpke.Context, err error) {
