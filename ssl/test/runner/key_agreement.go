...
// cecpq1 is combined elliptic curve (X25519) and post-quantum (new hope) key
// agreement.
type cecpq1 struct {
...
func (e *cecpq1) offer(rand io.Reader) (publicKey []byte, err error) {
...
func (e *cecpq1) accept(rand io.Reader, peerKey []byte) (publicKey []byte, preMasterSecret []byte, err error) {
...
func (e *cecpq1) finish(peerKey []byte) (preMasterSecret []byte, err error) {
...
func (ka *ecdheKeyAgreement) processClientKeyExchange(config *Config, cert *Certificate, ckx *clientKeyExchangeMsg, version uint16) ([]byte, error) {
	...
	offset := 1
	if _, postQuantum := ka.curve.(*cecpq1); postQuantum {
		// The larger key size requires an extra length byte.
