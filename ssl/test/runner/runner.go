...
// A timeoutConn implements an idle timeout on each Read and Write
// operation. Unlike most consumers, we want to be sensitive to a trickle of
// small reads and reset the timeout on idle time.
