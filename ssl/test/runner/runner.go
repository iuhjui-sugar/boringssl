...
func addCustomExtensionTests() {
	...
	testCases = append(testCases, testCase{
		...
		resumeSession: true,
		flags:         []string{"-enable-client-custom-extension", "-enable-early-data", "-expect-early-data-info", "-expect-reject-early-data"},
	})
	...
	testCases = append(testCases, testCase{
		...
		resumeSession: true,
		flags:         []string{"-enable-client-custom-extension", "-enable-early-data", "-expect-early-data-info", "-expect-accept-early-data"},
	})
	...
	testCases = append(testCases, testCase{
		...
		flags:         []string{"-enable-client-custom-extension", "-enable-early-data", "-expect-early-data-info"},
	})
	...
	testCases = append(testCases, testCase{
		...
		resumeSession: true,
		flags:         []string{"-enable-server-custom-extension", "-enable-early-data", "-expect-early-data-info"},
	})
