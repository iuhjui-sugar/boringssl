...
var tlsVersions = []tlsVersion{
	...
	{
		name:         "TLS13TypeExperiment",
		version:      VersionTLS13,
		excludeFlag:  "-no-tls13",
		versionWire:  tls13TypeExperimentVersion,
		tls13Variant: TLS13TypeExperiment,
	},
}
...
func addStateMachineCoverageTests(config stateMachineTestConfig) {
	...
	if config.protocol == tls {
		...
		tests = append(tests, testCase{
			testType: clientTest,
			name:     "TLS13TypeExperiment-EarlyData-Client",
			config: Config{
				MaxVersion:       VersionTLS13,
				MinVersion:       VersionTLS13,
				TLS13Variant:     TLS13TypeExperiment,
		...
		tests = append(tests, testCase{
			testType: serverTest,
			name:     "TLS13TypeExperiment-EarlyData-Server",
			config: Config{
				MaxVersion:   VersionTLS13,
				MinVersion:   VersionTLS13,
				TLS13Variant: TLS13TypeExperiment,
...
func addTLS13HandshakeTests() {
	...
	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "SkipEarlyData-TLS13TypeExperiment",
		config: Config{
			MaxVersion:   VersionTLS13,
			TLS13Variant: TLS13TypeExperiment,
			Bugs: ProtocolBugs{
	...
	testCases = append(testCases, testCase{
		testType: clientTest,
		name:     "TLS13TypeExperiment-EarlyData-Reject-Client",
		config: Config{
			MaxVersion:       VersionTLS13,
			MaxEarlyDataSize: 16384,
			TLS13Variant:     TLS13TypeExperiment,
