...
func addCurveTests() {
	...
	testCases = append(testCases, testCase{
		...
		flags: []string{"-server-preference", "-max-version", strconv.Itoa(VersionTLS13)},
	})
	testCases = append(testCases, testCase{
	...
	// As a server, CECPQ2 is supported by default.
	testCases = append(testCases, testCase{
		testType: serverTest,
	...
	testCases = append(testCases, testCase{
		testType: serverTest,
		name:     "CECPQ2EnabledByDefaultForAServer2",
		config: Config{
			MinVersion:       VersionTLS13,
			CurvePreferences: []CurveID{CurveX25519, CurveCECPQ2},
			DefaultCurves:    []CurveID{CurveX25519},
			Bugs: ProtocolBugs{
				FailIfHelloRetryRequested: true,
			},
