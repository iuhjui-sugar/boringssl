...
var testCipherSuites = []struct {
	...
	{"CECPQ1-RSA-AES256-GCM-SHA256", TLS_CECPQ1_RSA_WITH_AES_256_GCM_SHA256},
	{"CECPQ1-ECDSA-AES256-GCM-SHA256", TLS_CECPQ1_ECDSA_WITH_AES_256_GCM_SHA256},
...
func addCipherSuiteTests() {
	for _, suite := range testCipherSuites {
		...
		if hasComponent(suite.name, "CECPQ1") {
			...
			flags = append(flags, "-cipher", "kCECPQ1")
		}
