...
ResendHelloRetryRequest:
	...
	if sendHelloRetryRequest {
		...
		// TODO(davidben): draft-ietf-tls-esni-10 requires violating the
		// RFC 8446 rules. See https://github.com/tlswg/draft-ietf-tls-esni/issues/358
		// A later draft will likely fixes this. Remove this line if it does.
