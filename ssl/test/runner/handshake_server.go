...
Curves:
	...
	if encryptedExtensions.extensions.channelIDRequested {
		...
		channelID, err := hs.verifyChannelIDMessage(channelIDMsg, false)
		if err != nil {
			return err
		}
...
func (hs *serverHandshakeState) readFinished(out []byte, isResume bool) error {
	...
	if hs.hello.extensions.channelIDRequested {
		...
		channelID, err := hs.verifyChannelIDMessage(channelIDMsg, isResume)
		if err != nil {
			return err
		}
		c.channelID = channelID
...
func (hs *serverHandshakeState) verifyChannelIDMessage(channelIDMsg *channelIDMsg, isResume bool) (*ecdsa.PublicKey, error) {
