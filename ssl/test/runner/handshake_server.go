...
func (hs *serverHandshakeState) readClientHello() (isResume bool, err error) {
	...
	if config.fastradio_padding_enabled && len(hs.clientHello.raw) < 1000 {
		return false, errors.New("clienthello: record size should be larger than 1000 bytes when padding enabled.")
	}
