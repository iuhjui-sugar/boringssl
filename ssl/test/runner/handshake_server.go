...
ResendHelloRetryRequest:
	...
	clientTrafficSecret := hs.finishedHash.deriveSecret(hs.masterSecret, clientApplicationTrafficLabel)
	serverTrafficSecret := hs.finishedHash.deriveSecret(hs.masterSecret, serverApplicationTrafficLabel)
