...
RestartReadRecord:
	...
	// Accept Plaintext Handshake records when the content type TLS 1.3 variant is enabled.
	if c.config.TLS13Variant == TLS13TypeExperiment && want == recordTypeHandshake && typ == recordTypePlaintextHandshake {
