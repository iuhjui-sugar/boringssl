...
static void SetConfigPtr(SSL *ssl, const TestConfig *config) {
  SSL_set_ex_data(ssl, ex_data_index, (void *)config);
}

static const TestConfig *GetConfigPtr(SSL *ssl) {
  return (const TestConfig *)SSL_get_ex_data(ssl, ex_data_index);
}
...
int main(int argc, char **argv) {
  ...
  ex_data_index = SSL_get_ex_new_index(0, NULL, NULL, NULL, NULL);
