...
class CECPQ3KeyShare : public SSLKeyShare {
public:
  ~CECPQ3KeyShare() override {
    OPENSSL_cleanse(private_x25519_, sizeof(private_x25519_));
    OPENSSL_cleanse(private_SIKE_, sizeof(private_SIKE_));
  }

  uint16_t GroupID() const override {
    return SSL_CURVE_CECPQ3;
  }
...
CONSTEXPR_ARRAY NamedGroup kNamedGroups[] = {
    ...
    {NID_CECPQ3, SSL_CURVE_CECPQ3, "CECPQ3", "CECPQ3"},
};
...
UniquePtr<SSLKeyShare> SSLKeyShare::Create(uint16_t group_id) {
  switch (group_id) {
    ...
    case SSL_CURVE_CECPQ3:
      return UniquePtr<SSLKeyShare>(New<CECPQ3KeyShare>());
    default:
      return nullptr;
  }
}
