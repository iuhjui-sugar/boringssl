...
static enum ssl_hs_wait_t run_state(SSL *ssl, SSL_HANDSHAKE *hs) {
  ...
  switch (state) {
    case state_process_client_hello:
      return do_process_client_hello(ssl, hs);
    case state_send_server_hello:
      return do_send_server_hello(ssl, hs);
    case state_send_encrypted_extensions:
      return do_send_encrypted_extensions(ssl, hs);
    case state_send_certificate_request:
      return do_send_certificate_request(ssl, hs);
    case state_send_server_certificate:
      return do_send_server_certificate(ssl, hs);
    case state_send_server_certificate_verify:
      return do_send_server_certificate_verify(ssl, hs, 1 /* first run */);
    case state_complete_server_certificate_verify:
      return do_send_server_certificate_verify(ssl, hs, 0 /* complete */);
    case state_send_server_finished:
      return do_send_server_finished(ssl, hs);
    case state_flush:
      return do_flush(ssl, hs);
    case state_read_client_second_flight:
      return do_read_client_second_flight(ssl, hs);
    case state_process_client_certificate:
      return do_process_client_certificate(ssl, hs);
    case state_process_client_certificate_verify:
      return do_process_client_certificate_verify(ssl, hs);
    case state_process_client_finished:
      return do_process_client_finished(ssl, hs);
    case state_done:
      return ssl_hs_ok;
  }
