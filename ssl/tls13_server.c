...
/* kMaxEarlyDataAccepted is the maximum amount of early data that we will
 * accepted. Without this limit an attacker could send records at a faster rate
 * than we can process and cause trial decryption to loop forever. */
