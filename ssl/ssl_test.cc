...
TEST_P(SSLVersionTest, RawPublicKeyCertificate) {
  ...
  static const uint8_t spki[] = {
    ...
    
  };
  ...
  ASSERT_TRUE(key);
  ASSERT_TRUE(SSL_CTX_use_PrivateKey(server_ctx.get(), key.get()));
  ASSERT_TRUE(SSL_CTX_use_server_raw_public_key_certificate(server_ctx.get(),
    spki, sizeof(spki)));
  ...
  ASSERT_TRUE(SSL_CTX_use_server_raw_public_key_certificate(client_ctx.get(),
    spki, sizeof(spki)));
  ...
  // Enable the client to negotiate raw public key as the certificate type
  // but delegate verification to custom logic.
  ASSERT_TRUE(SSL_CTX_use_server_raw_public_key_certificate(client_ctx.get(),
    NULL, 0));
