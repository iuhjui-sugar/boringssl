...
TEST(SSLTest, StreamMethod) {
  ...
  ASSERT_TRUE(SSL_CTX_set_custom_stream_method(client_ctx.get(), &clientStreamMethod));
  ASSERT_TRUE(SSL_CTX_set_custom_stream_method(server_ctx.get(), &serverStreamMethod));
