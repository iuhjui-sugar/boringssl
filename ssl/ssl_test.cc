...
void GetEsniKeypairs(CBB *out_key_struct, std::vector<CBB> *out_privs,
                     bool bug_duplicate_group = false) {
  auto WritePrivKey = [out_privs](const uint8_t *bytes, size_t len) {
  ...
  if (bug_duplicate_group) {
    const uint8_t esni_keys_bytes[] = {
        ,
    };
    CBB_add_bytes(out_key_struct, esni_keys_bytes, sizeof(esni_keys_bytes));

    const uint8_t priv_bytes_1[] = {
        0x00, 0x1d, 0x8f, 0x6c, 0xfe, 0x35, 0x04, 0xa7, 0xed, 0x23, 0x5b, 0xb9,
        0xbf, 0xee, 0x93, 0xef, 0x33, 0xdc, 0x7b, 0xcc, 0x3d, 0xb9, 0x11, 0xa6,
        0xf9, 0xf1, 0xd3, 0x7c, 0xce, 0x6b, 0xfa, 0xf0, 0xf4, 0xba,
    };
    const uint8_t priv_bytes_2[] = {
        0x00, 0x17, 0x04, 0x20, 0x3c, 0x53, 0xfc, 0x52, 0xb8, 0x79, 0x88, 0x81,
        0xcf, 0xee, 0x92, 0x1b, 0x9e, 0xaa, 0xb5, 0x04, 0xb7, 0x89, 0xb1, 0x97,
        0xc8, 0xde, 0xef, 0x00, 0x33, 0xdc, 0x9d, 0x14, 0xb2, 0x03, 0xfd, 0xde,
    };
    ...
    const uint8_t priv_bytes_4[] = {
        0x00, 0x1d, 0x3f, 0xb0, 0x4a, 0x61, 0x17, 0xc0, 0xba, 0x0d, 0xae, 0x21,
        0x2a, 0x74, 0xe6, 0x42, 0x0b, 0x84, 0x36, 0x52, 0x26, 0x60, 0x76, 0x2b,
        0x69, 0x2b, 0xfa, 0xd3, 0xf7, 0x09, 0x2f, 0xbb, 0x7b, 0xb1,
    };
    ...
    const uint8_t esni_keys_bytes[] = {
        ,
    };
    CBB_add_bytes(out_key_struct, esni_keys_bytes, sizeof(esni_keys_bytes));

    const uint8_t priv_bytes_1[] = {
        0x00, 0x1d, 0xef, 0x4f, 0x91, 0xa0, 0xe2, 0x02, 0x88, 0x5a, 0xd5, 0x73,
        0x21, 0xbb, 0xab, 0xfd, 0x00, 0xae, 0xe1, 0x1c, 0x3c, 0x2d, 0x07, 0xf9,
        0x06, 0x72, 0xdd, 0x8e, 0xab, 0x3c, 0x43, 0x32, 0xc2, 0x95,
    };
    const uint8_t priv_bytes_2[] = {
        0x00, 0x17, 0x04, 0x20, 0xab, 0x63, 0x58, 0xd5, 0xab, 0x30, 0x7b, 0x6d,
        0xc8, 0x7f, 0xd2, 0x08, 0x95, 0x45, 0x6a, 0x6a, 0x27, 0x1f, 0xce, 0xc4,
        0x14, 0xeb, 0x75, 0x26, 0xf1, 0x32, 0x5e, 0xb2, 0x2f, 0x88, 0xaa, 0x14,
    };
    const uint8_t priv_bytes_3[] = {
...
TEST(SSLTest, ESNIKeysDuplicateGroupServer) {
  ...
  GetEsniKeypairs(&key_struct, &priv_keys, true);
...
TEST(SSLTest, ESNIParseRecordGood) {
  CBB esni_record;
  CBB_init(&esni_record, 0);

  // Serialize a random ESNIKeys into the ESNIRecord
  std::vector<CBB> priv_keys;
  GetEsniKeypairs(&esni_record, &priv_keys);
  const size_t expected_esni_keys_len = CBB_len(&esni_record);
  ...
  ASSERT_TRUE(SSL_parse_esni_record(
      CBB_data(&esni_record), CBB_len(&esni_record), &extracted_esni_keys,
  ...
  ASSERT_EQ(0, OPENSSL_memcmp(CBB_data(&esni_record), extracted_esni_keys,
...
TEST(SSLTest, ESNI) {
  ...
  CBB_init(&key_struct, 0);
  std::vector<CBB> priv_keys;
  GetEsniKeypairs(&key_struct, &priv_keys);
...
TEST(SSLTest, ESNIRetry) {
  ...
  CBB key_struct_old;
  CBB_init(&key_struct_old, 0);
  std::vector<CBB> priv_keys_old;
  GetEsniKeypairs(&key_struct_old, &priv_keys_old);
  ASSERT_TRUE(SSL_set_esni_keys(client.get(), CBB_data(&key_struct_old),
                                CBB_len(&key_struct_old)));
  CBB key_struct;
  CBB_init(&key_struct, 0);
  std::vector<CBB> priv_keys;
  GetEsniKeypairs(&key_struct, &priv_keys);
