...
static const CipherTest kCipherTests[] = {
    ...
    // SHA filter doesn't filter SHA256.
    {
        "RSA!SHA",
        {
            {TLS1_CK_RSA_WITH_AES_128_GCM_SHA256, 0},
    ...
    std::vector<uint8_t> expected;
      ...
      {TLS1_2_VERSION,
       {0x16, 0x03, 0x01, 0x00, 0x86, 0x01, 0x00, 0x00, 0x82, 0x03, 0x03, 0x00,
        ...
        0xc0, 0x13, 0xc0, 0x0a, 0xc0, 0x23, 0xc0, 0x14, 0x00, 0x9c, 0x00, 0x9d,
        0x00, 0x2f, 0x00, 0x3c, 0x00, 0x35, 0x00, 0x3d, 0x01, 0x00, 0x00, 0x37,
