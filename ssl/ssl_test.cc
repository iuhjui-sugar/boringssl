...
TEST(SSLTest, ESNI) {
  ...
  printf("ISKPK: %zu\n", CBB_len(&private_key));
  ASSERT_TRUE(SSL_set_esni_private_key(server.get(), CBB_data(&private_key), CBB_len(&private_key)));
