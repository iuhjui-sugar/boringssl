...
TEST(ReconstructSeqnumTest, Increment) {
  ...
  EXPECT_EQ(reconstruct_seqnum(0xff, 0xff, 0xffffffffffffffff), std::numeric_limits<uint64_t>::max());
  EXPECT_EQ(reconstruct_seqnum(0xff, 0xff, 0xfffffffffffffffe), std::numeric_limits<uint64_t>::max());
  EXPECT_EQ(reconstruct_seqnum(0xffff, 0xffff, 0xffffffffffffffff), std::numeric_limits<uint64_t>::max());
  EXPECT_EQ(reconstruct_seqnum(0xffff, 0xffff, 0xfffffffffffffffe), std::numeric_limits<uint64_t>::max());
}
...
TEST(ReconstructSeqnumTest, Decrement) {
  ...
  EXPECT_EQ(reconstruct_seqnum(0, 0xff, 0xffffffffffffffff), 0xffffffffffffff00u);
  EXPECT_EQ(reconstruct_seqnum(0, 0xff, 0xfffffffffffffffe), 0xffffffffffffff00u);
  EXPECT_EQ(reconstruct_seqnum(1, 0xff, 0xffffffffffffffff), 0xffffffffffffff01u);
  EXPECT_EQ(reconstruct_seqnum(1, 0xff, 0xfffffffffffffffe), 0xffffffffffffff01u);
  EXPECT_EQ(reconstruct_seqnum(0xfe, 0xff, 0xffffffffffffffff), 0xfffffffffffffffeu);
  EXPECT_EQ(reconstruct_seqnum(0xfd, 0xff, 0xfffffffffffffffe), 0xfffffffffffffffdu);
  EXPECT_EQ(reconstruct_seqnum(0, 0xffff, 0xffffffffffffffff), 0xffffffffffff0000u);
  EXPECT_EQ(reconstruct_seqnum(0, 0xffff, 0xfffffffffffffffe), 0xffffffffffff0000u);
  EXPECT_EQ(reconstruct_seqnum(1, 0xffff, 0xffffffffffffffff), 0xffffffffffff0001u);
  EXPECT_EQ(reconstruct_seqnum(1, 0xffff, 0xfffffffffffffffe), 0xffffffffffff0001u);
  EXPECT_EQ(reconstruct_seqnum(0xfffe, 0xffff, 0xffffffffffffffff), 0xfffffffffffffffeu);
  EXPECT_EQ(reconstruct_seqnum(0xfffd, 0xffff, 0xfffffffffffffffe), 0xfffffffffffffffdu);
}
