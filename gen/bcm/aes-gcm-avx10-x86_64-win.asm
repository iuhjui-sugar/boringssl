...
%endif
	...
	cmp	r8,4*64
	jb	NEAR $L$crypt_loop_4x_done__func3
...
$L$vaesenc_loop_first_4_vecs__func3:
	...
	sub	r8,4*64
	cmp	r8,4*64
	jb	NEAR $L$ghash_last_ciphertext_4x__func3
...
$L$aes128__func3:
	...
	sub	r8,4*64
	cmp	r8,4*64
	jae	NEAR $L$crypt_loop_4x__func3
...
$L$SEH_endprologue_aes_gcm_dec_update_vaes_avx10_512_16:
	...
	cmp	r8,4*64
	jb	NEAR $L$crypt_loop_4x_done__func4
...
$L$aes128__func4:
	...
	sub	r8,4*64
	cmp	r8,4*64
	jae	NEAR $L$crypt_loop_4x__func4
