...
platforms where `uint8_t` is a non-character type. However, as there is no
strict aliasing sanitizer, very few C and C++ are valid by strict aliasing, and
BoringSSL itself has some
[known strict aliasing bugs](https://crbug.com/boringssl/444), we strongly
