...
both_builders(
    ...
    properties = {
        "cmake_args": {
            # Newer versions of the Android NDK make NEON-only builds by default.
            # We rely on making NEON-optional builds for some of our test
            # coverage, but see https://crbug.com/boringssl/454.
