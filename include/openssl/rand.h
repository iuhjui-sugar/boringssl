 ...
 * rather opening /dev/urandom internally. It takes ownership of |fd|. This is
 * useful if, due to a sandbox, /dev/urandom isn't available. If used, it must
 * be called before |RAND_bytes| is called in the current address space.
 *
