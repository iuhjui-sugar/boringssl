...
// value of data which may be requested is 256 bytes. If more than 256
// bytes of data is requested, or if sufficient random data can not be
// obtained, abort() is called. RAND_bytes should normally be used
// instead of this function. This function should only be used for
// seed values or where malloc() can not be called. This function is
// not FIPS compliant.
