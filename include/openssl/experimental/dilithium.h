...
// The ML-DSA spec has now been standardized and ML-DSA is avaliable in
// BoringSSL.  This code should no longer be used. If you were using this you
// need to use the <openssl/mldsa.h> instead. This header and code will be
// removed from BoringSSL soon.
...
OPENSSL_DEPRECATED int DILITHIUM_generate_key(
...
OPENSSL_DEPRECATED int DILITHIUM_public_from_private(
...
// on failure.
OPENSSL_DEPRECATED int DILITHIUM_sign(
...
OPENSSL_DEPRECATED int DILITHIUM_verify(
...
// allocation error.
OPENSSL_DEPRECATED int DILITHIUM_marshal_public_key(
...
OPENSSL_DEPRECATED int DILITHIUM_parse_public_key(
...
// on allocation error.
OPENSSL_DEPRECATED int DILITHIUM_marshal_private_key(
...
// there are trailing bytes in |in|.
OPENSSL_DEPRECATED int DILITHIUM_parse_private_key(
