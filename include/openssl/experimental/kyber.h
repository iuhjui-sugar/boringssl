...
// the private key.
OPENSSL_EXPORT OPENSSL_DEPRECATED void KYBER_generate_key(
...
OPENSSL_EXPORT OPENSSL_DEPRECATED void KYBER_public_from_private(
...
// |out_shared_secret|.
OPENSSL_EXPORT OPENSSL_DEPRECATED void KYBER_encap(
...
// failure.
OPENSSL_EXPORT OPENSSL_DEPRECATED void KYBER_decap(
    uint8_t out_shared_secret[KYBER_SHARED_SECRET_BYTES],
...
// error.
OPENSSL_EXPORT OPENSSL_DEPRECATED int KYBER_marshal_public_key(
...
OPENSSL_EXPORT OPENSSL_DEPRECATED int KYBER_parse_public_key(
...
// allocation error.
OPENSSL_EXPORT OPENSSL_DEPRECATED int KYBER_marshal_private_key(
...
// there are trailing bytes in |in|.
OPENSSL_EXPORT OPENSSL_DEPRECATED int KYBER_parse_private_key(
