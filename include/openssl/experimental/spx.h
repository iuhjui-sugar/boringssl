...
OPENSSL_EXPORT OPENSSL_DEPRECATED void spx_generate_key(
...
// Public key: PK.seed || PK.root
OPENSSL_EXPORT OPENSSL_DEPRECATED void spx_generate_key_from_seed(
    uint8_t out_public_key[SPX_PUBLIC_KEY_BYTES],
    uint8_t out_secret_key[SPX_SECRET_KEY_BYTES],
...
OPENSSL_EXPORT OPENSSL_DEPRECATED void spx_sign(
...
// matches, 0 otherwise.
OPENSSL_EXPORT OPENSSL_DEPRECATED int spx_verify(
