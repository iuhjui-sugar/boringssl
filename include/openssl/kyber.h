...
// Kyber768 keys.
OPENSSL_EXPORT void KYBER_generate_key(uint8_t out_public_key[KYBER_PUBLIC_KEY_BYTES],
...
// |KYBER_ENCAP_ENTROPY| bytes of |in_entropy| for randomization. The
// decapsulating side will be able to recover |in_entropy| in full. This
...
// KYBER_decap is a deterministic function to decapsulate |in_ciphertext| and
...
OPENSSL_EXPORT void KYBER_decap(uint8_t *out_shared_secret, size_t out_shared_secret_len,
