...
// d2i_PKCS7_bio behaves like |d2i_PKCS7| but reads the input from |bio|. Note
// that, unlike other d2i functions, |d2i_PKCS7_bio| will always consume all
// data in |bio|.
...
// PKCS7_type_is_signed returns one. (We only supported signed data
// ContentInfos.)
...
// success and NULL on error. |sign_cert| and |pkey| must be NULL. |data| is
