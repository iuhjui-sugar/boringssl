...
typedef struct aead_seal_scatter_args {
#if defined(__cplusplus)
  aead_seal_scatter_args() { memset(this, 0, sizeof(*this)); }
#endif
 ...
 * into |out_tag|. |max_out_tag_len| must be sized to allow for the additional
 * |extra_in_len| bytes.
 *
 * The length of |nonce|, |nonce_len|, must be equal to the result of
 * |EVP_AEAD_nonce_length| for this AEAD.
