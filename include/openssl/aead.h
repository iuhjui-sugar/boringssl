 ...
 * filled with null bytes and |*out_len| set to zero.
 *
 ...
 * occurs, |out| and |out_tag| will be filled with null bytes and |*out_tag_len|
 * set to zero.
 *
 ...
 * occurs, |out| will be filled with null bytes.
 *
 * If |in| and |out| alias then |out| must be == |in|. */
