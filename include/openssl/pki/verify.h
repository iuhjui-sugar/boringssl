#ifndef THIRD_PARTY_CHROMIUM_CERTIFICATE_VERIFIER_VERIFY_H_
#define THIRD_PARTY_CHROMIUM_CERTIFICATE_VERIFIER_VERIFY_H_
...
class OPENSSL_EXPORT Opts {
 public:
  ...
  // ocsp_response is a DER-encoded stapled OCSP response, as returned by
  ...
  // check_revocation, if true (the default), will check if the certificate is
  // revoked in a CRLSet or other offline sources.
...
#endif  // THIRD_PARTY_CHROMIUM_CERTIFICATE_VERIFIER_VERIFY_H_
