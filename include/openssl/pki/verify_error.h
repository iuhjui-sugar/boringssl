...
class OPENSSL_EXPORT VerifyError {
 public:
  ...
  enum class StatusCode {
    ...
    // CERTIFICATE_INVALID means that the certificate was rejected as
    // invalid and unable to be used for certificate verification.
    CERTIFICATE_INVALID,
  ...
  // first occured, starting with 0 for the leaf certificate. If the error is
