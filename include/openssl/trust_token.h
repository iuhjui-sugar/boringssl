...
// PMBTokens (with no private metadata) and P-384, without RR verification.
...
// PMBTokens and P-384, without RR verification.
...
// |*out_srr| and |*out_srr_len| (respectively, |*out_sig| and |*out_sig_len|)
// to a newly-allocated buffer containing the SRR (respectively, the SRR
// signature). In other versions, it sets |*out_srr| and |*out_srr_len| to a
// newly-allocated buffer containing the response. It returns one on success or
// zero on failure.
