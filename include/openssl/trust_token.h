...
// |OPENSSL_free| when done. The caller should use |*out_token| and
// |*out_client_data| to determine whether this token or client data has been
// reused and whether to send a response to the requesting client. It returns
