...
// metadata. The key is an arbitrary bytestring used to encode the private
// metadata bit in the SRR. It returns one on success and zero on error.
...
// |private_metadata|. |public_metadata| must be one of the previously
// configured key IDs. |private_metadata| must be 0 or 1. It returns one on
