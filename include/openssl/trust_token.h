...
// |public_key|.
OPENSSL_EXPORT TRUST_TOKEN_CTX *TRUST_TOKEN_clear_init_client(uint32_t public_key);

// Initialize an issuer using the 'cleartext' protocol and private key
// |private_key|.
OPENSSL_EXPORT TRUST_TOKEN_CTX *TRUST_TOKEN_clear_init_issuer(uint32_t private_key);
...
OPENSSL_EXPORT TRUST_TOKEN_CTX *TRUST_TOKEN_privacy_pass_init_client(
...
OPENSSL_EXPORT bool TRUST_TOKEN_privacy_pass_client_add_key(TRUST_TOKEN_CTX *ctx,
                                                            const CBS key);

// TRUST_TOKEN_privacy_pass_init_issuer returns a trust token issuer |ctx|
// configured to use PrivacyPass with a max batchsize of |max_batchsize|.
OPENSSL_EXPORT TRUST_TOKEN_CTX *TRUST_TOKEN_privacy_pass_init_issuer(
    uint16_t max_batchsize);
...
OPENSSL_EXPORT bool TRUST_TOKEN_privacy_pass_issuer_add_key(TRUST_TOKEN_CTX *ctx,
                                                            const CBS key);

// TRUST_TOKEN_CTX_free releases memory associated with |ctx|.
OPENSSL_EXPORT void TRUST_TOKEN_CTX_free(TRUST_TOKEN_CTX *ctx);
...
OPENSSL_EXPORT bool TRUST_TOKEN_client_set_srr_key(TRUST_TOKEN_CTX *ctx,
                                                   EVP_PKEY *key);

// TRUST_TOKEN_issuer_set_srr_key sets the private key used to sign the SRR.
OPENSSL_EXPORT bool TRUST_TOKEN_issuer_set_srr_key(TRUST_TOKEN_CTX *ctx,
                                                   EVP_PKEY *key);
...
// false on error.
OPENSSL_EXPORT bool TRUST_TOKEN_client_begin_issuance(TRUST_TOKEN_CTX *ctx,
                                                      uint8_t **out,
                                                      size_t *out_len,
                                                      size_t count);
...
OPENSSL_EXPORT bool TRUST_TOKEN_issuer_set_metadata(TRUST_TOKEN_CTX *ctx,
...
// error.
OPENSSL_EXPORT bool TRUST_TOKEN_issuer_perform_issuance(TRUST_TOKEN_CTX *ctx,
                                                        uint8_t **out,
                                                        size_t *out_len,
                                                        const CBS request);
...
OPENSSL_EXPORT STACK_OF(TRUST_TOKEN) *
    TRUST_TOKEN_client_finish_issuance(TRUST_TOKEN_CTX *ctx,
                                       const CBS response);
...
OPENSSL_EXPORT bool TRUST_TOKEN_client_begin_redemption(
    TRUST_TOKEN_CTX *ctx, uint8_t **out, size_t *out_len,
    const TRUST_TOKEN *token, const CBS data);
...
OPENSSL_EXPORT bool TRUST_TOKEN_issuer_redeem(TRUST_TOKEN_CTX *ctx,
...
OPENSSL_EXPORT bool TRUST_TOKEN_client_finish_redemption(TRUST_TOKEN_CTX *ctx,
                                                         bool *result,
                                                         uint8_t **out_srr,
                                                         size_t *out_srr_len,
                                                         const CBS response);
