...
// with the end of the input.
//
// WARNING: Callers should not rely on the in-place update mode. It is often
...
// bounds. Failing the correctly size the buffer, typically with the first mode,
// will result in a potentially exploitable memory error.
