...
// |tag| as the tag instead of INTEGER. This may be useful if the INTEGER type
// is implicitly tagged.
...
// as the tag instead of INTEGER. This may be useful if the INTEGER type is
// implicitly tagged.
