...
/* NEWHOPE_OFFERMSG_LENGTH is the length of the offer party's message to the
 * accepting party. */
...
/* NEWHOPE_finish completes a key exchange given an accept message |msg| and the
 * previously generated secret |sk|. The result of the key exchange is written
 * to |out_key|, which must have space for |SHA256_DIGEST_LENGTH| bytes. Returns
