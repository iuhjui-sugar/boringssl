...
/* NEWHOPE_POLY_encode encodes |p| into |r|. */
OPENSSL_EXPORT void NEWHOPE_POLY_encode(uint8_t r[NEWHOPE_POLY_LENGTH],
                                        const NEWHOPE_POLY *p);

/* NEWHOPE_POLY_decode decodes |a| into |r|. */
OPENSSL_EXPORT void NEWHOPE_POLY_decode(NEWHOPE_POLY *r,
