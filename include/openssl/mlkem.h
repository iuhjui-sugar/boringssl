...
// generated by |MLKEM_generate_key|. It returns 0 if |seed_len| is incorrect
// and 1 otherwise.
OPENSSL_EXPORT int MLKEM_private_key_from_seed(
    struct MLKEM_private_key *out_private_key, const uint8_t *seed,
    size_t seed_len);
...
OPENSSL_EXPORT int MLKEM_decap(
    uint8_t out_shared_secret[MLKEM_SHARED_SECRET_BYTES],
