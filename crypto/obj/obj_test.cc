...
TEST(ObjTest, TestObj2Txt) {
  ...
  ASSERT_TRUE(ExpectObj2Txt(kSHA256WithRSAEncryption, sizeof(kSHA256WithRSAEncryption),
  ...
  ASSERT_TRUE(ExpectObj2Txt(kTestOID, sizeof(kTestOID), true /* don't return name */,
