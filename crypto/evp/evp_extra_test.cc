...
TEST(EVPExtraTest, Ed25519) {
  ...
  ASSERT_TRUE(EVP_DigestSignInit(ctx.get(), nullptr, nullptr, nullptr, privkey.get()));
  ...
  ctx.Reset();
  ASSERT_TRUE(EVP_DigestVerifyInit(ctx.get(), nullptr, nullptr, nullptr, privkey.get()));
