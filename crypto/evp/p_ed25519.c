...
/* Ed25519 has no parameters to initialize, copy, cleanup, or configure. */

static int pkey_ed25519_init(EVP_PKEY_CTX *ctx) { return 1; }
static int pkey_ed25519_copy(EVP_PKEY_CTX *dst, EVP_PKEY_CTX *src) { return 1; }
static void pkey_ed25519_cleanup(EVP_PKEY_CTX *ctx) {}

static int pkey_ed25519_ctrl(EVP_PKEY_CTX *ctx, int type, int p1, void *p2) {
