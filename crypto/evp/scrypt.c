...
/* xor_blocks sets |*out| to be |*a| XOR |*b|. */
static void xor_blocks(block_t *out, const block_t *a, const block_t *b) {
...
int EVP_PBE_scrypt(const char *password, size_t password_len,
  ...
  OPENSSL_COMPILE_ASSERT(UINT64_MAX >= ((size_t)-1), size_t_fits_in_u64);
