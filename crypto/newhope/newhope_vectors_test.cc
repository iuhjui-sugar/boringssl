...
static bool TestNewhope(FileTest *t, void *arg) {
  if (t->GetType() == "OfferSK") {
    ...
    NEWHOPE_POLY_decode(&offer_sk, offer_sk_bytes.data());
    NEWHOPE_POLY_decode(&accept_pk, accept_pk_bytes.data());
    NEWHOPE_POLY_decode(&accept_rec, accept_rec_bytes.data());
    ...
    NEWHOPE_POLY_decode(&offer_pk, offer_pk_bytes.data());
    NEWHOPE_POLY_decode(&offer_a, offer_a_bytes.data());
    NEWHOPE_POLY_decode(&accept_sk, accept_sk_bytes.data());
    NEWHOPE_POLY_decode(&accept_epp, accept_epp_bytes.data());
