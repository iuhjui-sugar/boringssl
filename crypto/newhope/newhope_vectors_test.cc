...
static bool TestNewhope(FileTest *t, void *arg) {
  std::unique_ptr<NEWHOPE_POLY> a(NEWHOPE_POLY_new());
  std::unique_ptr<NEWHOPE_POLY> s(NEWHOPE_POLY_new()), sp(NEWHOPE_POLY_new());
  std::unique_ptr<NEWHOPE_POLY> e(NEWHOPE_POLY_new()), ep(NEWHOPE_POLY_new()),
      epp(NEWHOPE_POLY_new());
  std::unique_ptr<NEWHOPE_POLY> in_pk(NEWHOPE_POLY_new());
  std::unique_ptr<NEWHOPE_POLY> in_rec(NEWHOPE_POLY_new());
