...
/* _XOPEN_SOURCE is in order to get |pthread_rwlock_t| from pthread.h */
...
OPENSSL_COMPILE_ASSERT(sizeof(CRYPTO_mutex_t) >= sizeof(pthread_rwlock_t),
                       CRYPTO_mutex_t_too_small);
