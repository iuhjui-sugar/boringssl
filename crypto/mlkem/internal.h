...
// MLKEM_GENERATE_KEY_ENTROPY is the number of bytes of uniformly random entropy
// necessary to generate a key.
#define MLKEM_GENERATE_KEY_ENTROPY 64
...
// directly.
OPENSSL_EXPORT void MLKEM_generate_key_external_entropy(
...
OPENSSL_EXPORT void MLKEM_encap_external_entropy(
...
// MLKEM1024_generate_key_external_entropy is a deterministic function to create
// a pair of ML-KEM-768 keys, using the supplied entropy. The entropy needs to
// be uniformly random generated. This function is should only be used for
// tests, regular callers should use the non-deterministic
// |MLKEM1024_generate_key| directly.
OPENSSL_EXPORT void MLKEM1024_generate_key_external_entropy(
