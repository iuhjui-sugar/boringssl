...
TEST(PKCS8Test, TestRoundTripNID_pbe_WithSHA1And3_Key_TripleDES_1_iteration) {
  TestRoundTrip(NID_pbe_WithSHA1And3_Key_TripleDES_CBC, nullptr,
                "password", nullptr, 0, 1);
}

TEST(PKCS8Test, TestRoundTripNID_pbe_WithSHA1And3_Key_TripleDES_pw_edgecase) {
  TestRoundTrip(NID_pbe_WithSHA1And3_Key_TripleDES_CBC, nullptr, "",
                nullptr, 0, 1);
...
TEST(PKCS8Test, TestRoundTripNID_pbe_WithSHA1And40BitRC2_CBC) {
  TestRoundTrip(NID_pbe_WithSHA1And40BitRC2_CBC, nullptr, "password",
                nullptr, 0, 10);
}

TEST(PKCS8Test, TestRoundTripNID_pbe_WithSHA1And128BitRC4) {
  TestRoundTrip(NID_pbe_WithSHA1And128BitRC4, nullptr, "password",
                nullptr, 0, 10);
}

TEST(PKCS8Test, TestRoundTripPBES2) {
