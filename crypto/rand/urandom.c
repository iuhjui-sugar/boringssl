...
/* global_lock is used to protect the |_requested| variables. */
...
/* urandom_buffering_requested is set by |RAND_I_promise_not_to_fork|.  It's
...
static void init_once(void) {
  CRYPTO_STATIC_MUTEX_lock_read(&global_lock);
