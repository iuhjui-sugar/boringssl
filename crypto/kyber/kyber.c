...
static const size_t kEncodedScalarSize = kLog2Prime * DEGREE / 8;
static const size_t kEncodedVectorSize = kEncodedScalarSize * RANK;
static const size_t kCompressedVectorSize = kDU * RANK * DEGREE / 8;
...
// |bits| many bits. This results in |DEGREE|*|bits|/8 bytes of output.
...
// Algorithm 3 of the Kyber spec. Reads |DEGREE|*|bits|/8 bytes from |in|.
...
// Decodes 32*|RANK|*|bits| bytes from |in| into |out|.
