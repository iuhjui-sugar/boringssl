...
// BORINGSSL_keccak_finalize must be called after the last absorb call to
// prepare |ctx| for squeezing.
OPENSSL_EXPORT void BORINGSSL_keccak_finalize(struct BORINGSSL_keccak_st *ctx);
