...
// DILITHIUM_sign_with_randomizer generates a signature for the message |msg| of
// length |msg_len| using |private_key| and writes the encoded signature to
// |out_encoded_signature|. This uses |randomizer| (which either contains zeroes
// or external entropy) as the randomized part of the signature.
