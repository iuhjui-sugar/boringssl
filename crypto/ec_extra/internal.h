...
// ec_hash_to_scalar hashes |msg| to an element modulo the order of |group| and
// returns a |BIGNUM| representing the element. |dst| is the domain separation
// tag and must be unique for each protocol.
