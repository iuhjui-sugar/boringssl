...
// draft-irtf-cfrg-hash-to-curve-06. We currently only implement the P-256 and
// P-521 suites, but others can be added as needed.

// ec_hash_to_curve_p256_sha256_sswu hashes |msg| to a point on |group| and
...
// ec_hash_to_scalar_p256_xmd_sha256 hashes |msg| to a scalar on |group| and
// writes the result to |out|, using the hash_to_field operation from the
// P256_XMD:SHA-256_SSWU_RO_ suite, but generating a value modulo the group
...
// |ec_hash_to_scalar_p256_xmd_sha256| must use distinct values of |dst| for
// each use.
OPENSSL_EXPORT int ec_hash_to_scalar_p256_xmd_sha256(
