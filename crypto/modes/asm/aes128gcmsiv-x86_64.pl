...
.type aesgcmsiv_htable_polyval,\@function,2
.align 16
...
.type aesgcmsiv_polyval_horner,\@function,2
.align 16
...
.type aes128gcmsiv_kdf,\@function,2
.align 16
aes128gcmsiv_kdf:
.cfi_startproc
...
.type aes256gcmsiv_dec,\@function,2
.align 16
aes256gcmsiv_dec:
___
  } else {
...
$code.=<<___;
    ...
    vmovdqa $CTR1, 0*16($PT)
    vmovdqa $CTR2, 1*16($PT)
    vmovdqa $CTR3, 2*16($PT)
    vmovdqa $CTR4, 3*16($PT)
    vmovdqa $CTR5, 4*16($PT)
    vmovdqa $CTR6, 5*16($PT)
...
.type aes128gcmsiv_ecb_enc_block,\@function,2
.align 16
...
.type aes256gcmsiv_aes_ks_enc_x1,\@function,2
.align 16
...
.type aes256gcmsiv_ecb_enc_block,\@function,2
.align 16
...
.type aes256gcmsiv_enc_msg_x4,\@function,2
.align 16
...
.type aes256gcmsiv_enc_msg_x8,\@function,2
.align 16
...
.type aes256gcmsiv_kdf,\@function,2
.align 16
aes256gcmsiv_kdf:
.cfi_startproc
# parameter 1: %rdi                         Pointer to NONCE
