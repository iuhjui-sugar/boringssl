...
TEST(X509Test, TestX25519) {
  ...
  EXPECT_TRUE(
      EVP_PKEY_get_raw_public_key(pkey.get(), public_value,
                                  &public_value_size) &&
      public_value_size == sizeof(kExpectedPublicValue) &&
      memcmp(public_value, kExpectedPublicValue, sizeof(public_value)) == 0);
}
