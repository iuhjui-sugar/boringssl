...
TEST(CompilerTest, IntegerRepresentation) {
  ...
  static_assert(CHAR_MIN == -128, "BoringSSL only suports 8-bit chars");
  static_assert(CHAR_MAX == 127, "BoringSSL only suports 8-bit chars");
  static_assert(UCHAR_MAX == 0xff, "BoringSSL only suports 8-bit chars");
