...
// for us to support, so we do intentionally depend on a variety of platform
// behaviors. This file aims to aims to document and test those dependencies,
// so that platforms outside our scope are flagged.
