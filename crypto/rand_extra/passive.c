...
// a lack of entropy. This signal is used as an indicate to feed it more.
void RAND_need_entropy(size_t bytes_needed) {
  ...
  const int used_rdrand = CRYPTO_get_seed_entropy(buf, todo);
  RAND_load_entropy(buf, todo, used_rdrand);
}
