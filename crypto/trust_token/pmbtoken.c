...
int pmbtoken_h(EC_RAW_POINT *out_h) {
  ...
  static const uint8_t kH[] = {
      0x04, 0xd2, 0xa1, 0xa6, 0x87, 0x79, 0x6a, 0xa9, 0xd8, 0x14, 0x0f,
      0x67, 0xd1, 0x6d, 0xfd, 0x04, 0x6d, 0xba, 0x88, 0xf9, 0x29, 0xfc,
      0x75, 0xba, 0x44, 0xe1, 0x3f, 0x5b, 0x44, 0x00, 0xd2, 0x36, 0x95,
      0xda, 0x79, 0x30, 0x9b, 0xc4, 0x0e, 0x5c, 0x60, 0x0a, 0xca, 0x46,
      0xf8, 0x4f, 0x64, 0xb5, 0xd5, 0xd2, 0x7a, 0x23, 0xdf, 0x96, 0xac,
      0x6b, 0x58, 0x20, 0x07, 0x39, 0xb9, 0x26, 0xcc, 0xf7, 0xc9
  };
...
static int hash_s(EC_GROUP *group, EC_RAW_POINT *out, const EC_RAW_POINT *t,
  ...
  if (!CBB_init(&cbb, 0) ||
      ...
      !ec_hash_to_curve_p256_xmd_sha256_sswu(group, out, kHashSLabel,
...
static int hash_c(const EC_GROUP *group, EC_SCALAR *out, uint8_t *buf,
  ...
  return ec_hash_to_scalar_p256_xmd_sha256(group, out, kHashCLabel,
