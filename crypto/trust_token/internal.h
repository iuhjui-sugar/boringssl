...
//
// P-384 is used since there are potential theoretical attacks that reduce the
// security level of the curve by log2(# of computations), which could reduce
// the security level of P-256 below acceptable security levels.
