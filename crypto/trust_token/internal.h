...
// specified by |public_metadata| and stores the value of the private metadata
...
int pmbtoken_read(TRUST_TOKEN_ISSUER *ctx, uint8_t *out_private_metadata,
                  PMBTOKEN_TOKEN *token, uint32_t public_metadata);
...
struct trust_token_issuer_st {
  ...
  // public_metadata is the public metadata key ID that should be used for
