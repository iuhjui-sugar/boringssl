...
int TRUST_TOKEN_generate_key(uint8_t *out_priv_key, size_t *out_priv_key_len,
  ...
  if (!CBB_init_fixed(&cbb, out_priv_key, max_priv_key_len) ||
      ...
      !CBB_add_bytes(&cbb, x0.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_u16(&cbb, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_bytes(&cbb, y0.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_u16(&cbb, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_bytes(&cbb, x1.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_u16(&cbb, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_bytes(&cbb, y1.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_u16(&cbb, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_bytes(&cbb, xs.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_u16(&cbb, BN_num_bytes(EC_GROUP_get0_order(group))) ||
      !CBB_add_bytes(&cbb, ys.bytes, BN_num_bytes(EC_GROUP_get0_order(group))) ||
