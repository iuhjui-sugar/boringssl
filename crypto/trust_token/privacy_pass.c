...
static EC_POINT *h_gen(void) {
  ...
  static const BN_ULONG kHGenX[] = {
      TOBN(0x4d8d48b3, 0x5b20de11), TOBN(0x094df9fb, 0x8cb04993),
      TOBN(0xb7d8846b, 0x4fda3b97), TOBN(0x4249dfb5, 0x2c696d50),
      TOBN(0x1d7f417d, 0xc09b5a18), TOBN(0x9f651941, 0xa84b7ece),
      TOBN(0x47b19930, 0x222fb93c), TOBN(0xf224c451, 0xe4708465),
      TOBN(0x00000000, 0x0000003e),
  };
  static const BIGNUM kX = STATIC_BIGNUM(kHGenX);

  static const BN_ULONG kHGenY[] = {
      TOBN(0x6feba7c1, 0x70f947b1), TOBN(0x52aa00bf, 0x9f08137f),
      TOBN(0x8145cb85, 0xfcb2f56a), TOBN(0x73e580e4, 0xeecc8048),
      TOBN(0x58997acc, 0x26621e64), TOBN(0x213ff760, 0xc9add9e3),
      TOBN(0x475d01d1, 0x40ac4a03), TOBN(0x55a81de8, 0xfb1a6511),
      TOBN(0x00000000, 0x000001fd),
  };
