...
static int voprf_generate_fixed_key(const VOPRF_METHOD *method, CBB *out_private,
                                    CBB *out_public, const uint8_t *seed, size_t seed_len) {
...
int voprf_exp2_generate_fixed_key(CBB *out_private, CBB *out_public,
  ...
  return voprf_generate_fixed_key(&voprf_exp2_method, out_private, out_public,
                                  seed, seed_len);
}
