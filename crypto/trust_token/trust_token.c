...
const TRUST_TOKEN_METHOD *TRUST_TOKEN_experiment_v1(void) {
  static const TRUST_TOKEN_METHOD kMethod = {
      ...
      pmbtoken_exp1_generate_fixed_key,
...
const TRUST_TOKEN_METHOD *TRUST_TOKEN_experiment_v2_pmb(void) {
  static const TRUST_TOKEN_METHOD kMethod = {
      ...
      pmbtoken_exp2_generate_fixed_key,
...
int TRUST_TOKEN_generate_fixed_key(
  ...
  if (!method->generate_fixed_key(&priv_cbb, &pub_cbb, seed, seed_len)) {
    goto err;
  }
