...
const TRUST_TOKEN_METHOD *TRUST_TOKEN_experiment_v1(void) {
  static const TRUST_TOKEN_METHOD kMethod = {
      ...
      pmbtoken_exp1_generate_key_from_secret,
...
const TRUST_TOKEN_METHOD *TRUST_TOKEN_experiment_v2_voprf(void) {
  static const TRUST_TOKEN_METHOD kMethod = {
      ...
      voprf_exp2_generate_key_from_secret,
...
const TRUST_TOKEN_METHOD *TRUST_TOKEN_experiment_v2_pmb(void) {
  static const TRUST_TOKEN_METHOD kMethod = {
      ...
      pmbtoken_exp2_generate_key_from_secret,
...
int TRUST_TOKEN_generate_key_from_secret(
  ...
  if (!method->generate_key_from_secret(&priv_cbb, &pub_cbb, secret,
                                        secret_len)) {
    goto err;
  }
