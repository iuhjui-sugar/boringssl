...
int SPAKE2_generate_msg(SPAKE2_CTX *ctx, uint8_t *out, size_t *out_len,
  ...
  /* The bottom three bits are cleared in order to make |private_tmp| a
   * multiple of the cofactor, eight. This will clear the cofactor when we
   * multiply with the peer's input later. */
  private_tmp[0] &= 248;
