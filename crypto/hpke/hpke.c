...
static int hpke_extract_and_expand(EVP_HPKE_CTX *hpke, uint8_t *out_key,
  ...
  const char *kExtractLabel = "dh";
  const char *kExpandLabel = "prk";
...
static int hpke_key_schedule(EVP_HPKE_CTX *hpke, const uint8_t *zz,
  ...
  const char *kPskIdHashLabel = "pskID_hash";
  ...
  const char *kInfoHashLabel = "info";
  ...
  const char *kPskHashLabel = "psk_hash";
  ...
  const char *kExporterSecretLabel = "exp";
