...
struct evp_hpke_kem_st {
  ...
  int (*generate_key)(EVP_HPKE_KEY *key, const EVP_HPKE_KEM *kem);
...
static int x25519_generate_key(EVP_HPKE_KEY *key, const EVP_HPKE_KEM *kem) {
