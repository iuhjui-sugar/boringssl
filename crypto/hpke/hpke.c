...
// This file implements draft-irtf-cfrg-hpke-06.
...
static const char kHpkeRfcId[] = "HPKE-06 ";
...
static int hpke_key_schedule(EVP_HPKE_CTX *hpke, uint8_t mode,
  ...
  static const char kIVExpandLabel[] = "iv";
  if (!hpke_labeled_expand(hpke->hkdf_md, hpke->iv, EVP_AEAD_nonce_length(aead),
                           secret, secret_len, suite_id, sizeof(suite_id),
                           kIVExpandLabel, context, context_len)) {
    return 0;
  }
