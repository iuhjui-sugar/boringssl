...
// EVP_HPKE_CTX_setup_sender encapsulates a shared secret for |peer_public_key|
// and sets up |ctx| as a sender context. It writes the encapsulated shared
...
// EVP_HPKE_CTX_setup_recipient decapsulates the shared secret in |enc| with
// |key| and sets up |ctx| as a recipient context. It returns one on success and
// zero on failure. Note that |enc| may be invalid, in which case this function
