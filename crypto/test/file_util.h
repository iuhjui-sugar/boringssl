...
// TemporaryFile manages a temporary file for testing. No attempt is made to
// avoid TOCTOU bugs with shared temporary directories. This is intended for
// testing only.
class TemporaryFile {
 public:
...
// TemporaryDirectory manages a temporary directory for testing. No attempt is
// made to avoid TOCTOU bugs with shared temporary directories. This is intended
// for testing only.
