...
.Labi_test_trampoline_begin:
	...
	// mandate that x29 always point to a frame. iOS64 elects to do so.
	ldp	d8, d9, [$state], #16
...
$code .= <<____;
// abi_test_clobber_v8_high clobbers only the upper half of v8. AAPCS64 only
// requires the lower half (d8) be preserved.
.type	abi_test_clobber_v8_high, %function
.globl	abi_test_clobber_v8_high
.align	4
abi_test_clobber_v8_high:
	fmov	v8.d[1], xzr
	ret
____
