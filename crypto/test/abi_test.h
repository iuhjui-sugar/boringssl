...
//
// In aarch64, r18 (x18 in a 64-bit context) is the platform register. iOS says
...
// registers. Thus this framework ignores register's existence. We test r18
// violations in arm-xlate.pl.
#define LOOP_CALLER_STATE_REGISTERS()                                \
