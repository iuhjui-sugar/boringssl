...
// abi_test_unwind_start points the instruction that starts unwind testing in
...
// abi_test_unwind_return points the instruction immediately after the call in
...
// abi_test_unwind_stop points the value of the instruction pointer at the final
