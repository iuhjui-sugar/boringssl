...
// The tmmintrin.h include is broken on some GCC installations and #errors
// unless SSSE3 is unconditionally enabled by compiler flags.
#if defined(__GNUC__) && !defined(__SSSE3___) && !defined(__clang__)
#define __SSSE3___
