...
static int ec_GFp_nistp256_precompute_mult(EC_GROUP *group, BN_CTX *ctx) {
  return 0;
}

static int ec_GFp_nistp256_have_precompute_mult(const EC_GROUP *group) {
  return 0;
}
...
const EC_METHOD *EC_GFp_nistp256_method(void) {
  static const EC_METHOD ret = {
      ...
      ec_GFp_nistp256_precompute_mult, ec_GFp_nistp256_have_precompute_mult,
