...
// FIPS_service_indicator_is_unlocked returns true if the service indicator is
// currently unlocked. This is for testing only.
OPENSSL_EXPORT int FIPS_service_indicator_is_unlocked(void);

// The following functions may call |FIPS_service_indicator_unlock_state| if
