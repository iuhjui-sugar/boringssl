...
static void DoCipherFinal(EVP_CIPHER_CTX *ctx, std::vector<uint8_t> *out,
  ...
  int approved = BORINGSSL_FIPS_NOT_APPROVED;
...
class AEAD_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<AEADTestVector> {};

INSTANTIATE_TEST_SUITE_P(All, AEAD_ServiceIndicatorTest,
...
TEST_P(AEAD_ServiceIndicatorTest, EVP_AEAD) {
  ...
  EXPECT_EQ(approved, BORINGSSL_FIPS_NOT_APPROVED);
  ASSERT_TRUE(CALL_SERVICE_AND_CHECK_APPROVED(
  ...
  // functions should fail and return |BORINGSSL_FIPS_NOT_APPROVED|.
...
class EVP_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<CipherTestVector> {};
...
INSTANTIATE_TEST_SUITE_P(All, EVP_ServiceIndicatorTest,
...
class EVP_MD_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<DigestTestVector> {};

INSTANTIATE_TEST_SUITE_P(All, EVP_MD_ServiceIndicatorTest,
...
static const struct HMACTestVector {
  ...
  const int expect_approved;
    ...
    {EVP_sha1, kHMACOutput_sha1, BORINGSSL_FIPS_APPROVED},
    {EVP_sha224, kHMACOutput_sha224, BORINGSSL_FIPS_APPROVED},
    {EVP_sha256, kHMACOutput_sha256, BORINGSSL_FIPS_APPROVED},
    {EVP_sha384, kHMACOutput_sha384, BORINGSSL_FIPS_APPROVED},
    {EVP_sha512, kHMACOutput_sha512, BORINGSSL_FIPS_APPROVED},
    {EVP_sha512_256, kHMACOutput_sha512_256, BORINGSSL_FIPS_APPROVED},
};

class HMAC_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<HMACTestVector> {};

INSTANTIATE_TEST_SUITE_P(All, HMAC_ServiceIndicatorTest,
...
TEST(ServiceIndicatorTest, RSAKeyGen) {
  ...
  for (const size_t bits : {2048, 3072, 4096}) {
    ...
    EXPECT_TRUE(CALL_SERVICE_AND_CHECK_APPROVED(
        approved, RSA_generate_key_fips(rsa.get(), bits, nullptr)));
    EXPECT_EQ(approved, BORINGSSL_FIPS_APPROVED);
...
struct RSATestVector {
  ...
  int sig_gen_expect_approved;
  // expected to be approved or not for signature verification.
  int sig_ver_expect_approved;
};

static const struct RSATestVector kRSATestVectors[] = {
    // RSA test cases that are not approved in any case.
    {512, &EVP_sha1, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {512, &EVP_sha256, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {1024, &EVP_md5, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {1536, &EVP_sha256, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {1536, &EVP_sha512, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {2048, &EVP_md5, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {3071, &EVP_md5, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {3071, &EVP_sha256, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {3071, &EVP_sha512, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},
    {4096, &EVP_md5, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED},

    // RSA test cases that are approved.
    {1024, &EVP_sha1, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {1024, &EVP_sha256, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {1024, &EVP_sha512, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {1024, &EVP_sha1, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {1024, &EVP_sha256, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {1024, &EVP_sha512, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},

    {2048, &EVP_sha1, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha224, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha256, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha384, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha512, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha1, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha224, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha256, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha384, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {2048, &EVP_sha512, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {3072, &EVP_sha1, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha224, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha256, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha384, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha512, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha1, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha224, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha256, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha384, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {3072, &EVP_sha512, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {4096, &EVP_sha1, false, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha224, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha256, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha384, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha512, false, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha1, true, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha224, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha256, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha384, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {4096, &EVP_sha512, true, BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
};

class RSA_ServiceIndicatorTest : public bssl::TestWithNoErrors<RSATestVector> {
};

INSTANTIATE_TEST_SUITE_P(All, RSA_ServiceIndicatorTest,
...
static const struct ECDSATestVector kECDSATestVectors[] = {
    ...
    {NID_secp224r1, &EVP_sha1, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, &EVP_sha224, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, &EVP_sha256, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, &EVP_sha384, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, &EVP_sha512, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {NID_X9_62_prime256v1, &EVP_sha1, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, &EVP_sha224, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, &EVP_sha256, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, &EVP_sha384, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, &EVP_sha512, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {NID_secp384r1, &EVP_sha1, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, &EVP_sha224, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, &EVP_sha256, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, &EVP_sha384, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, &EVP_sha512, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {NID_secp521r1, &EVP_sha1, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, &EVP_sha224, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, &EVP_sha256, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, &EVP_sha384, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, &EVP_sha512, BORINGSSL_FIPS_APPROVED,
     BORINGSSL_FIPS_APPROVED, BORINGSSL_FIPS_APPROVED},

    {NID_secp256k1, &EVP_sha1, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, &EVP_sha224, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, &EVP_sha256, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, &EVP_sha384, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, &EVP_sha512, BORINGSSL_FIPS_NOT_APPROVED,
     BORINGSSL_FIPS_NOT_APPROVED, BORINGSSL_FIPS_NOT_APPROVED},
};

class ECDSA_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<ECDSATestVector> {};

INSTANTIATE_TEST_SUITE_P(All, ECDSA_ServiceIndicatorTest,
...
TEST_P(ECDSA_ServiceIndicatorTest, ManualECDSASignVerify) {
  ...
  EXPECT_EQ(approved, ecdsaTestVector.sig_gen_expect_approved);
  sig.resize(sig_len);
  ...
  EXPECT_EQ(approved, ecdsaTestVector.sig_ver_expect_approved);
}
...
static const struct ECDHTestVector kECDHTestVectors[] = {
    ...
    // inputted.
    {NID_secp224r1, SHA224_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, SHA256_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, SHA384_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp224r1, SHA512_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},

    {NID_X9_62_prime256v1, SHA224_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, SHA256_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, SHA384_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_X9_62_prime256v1, SHA512_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},

    {NID_secp384r1, SHA224_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, SHA256_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, SHA384_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp384r1, SHA512_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},

    {NID_secp521r1, SHA224_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, SHA256_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, SHA384_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},
    {NID_secp521r1, SHA512_DIGEST_LENGTH, BORINGSSL_FIPS_APPROVED},

    {NID_secp256k1, SHA224_DIGEST_LENGTH, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, SHA256_DIGEST_LENGTH, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, SHA384_DIGEST_LENGTH, BORINGSSL_FIPS_NOT_APPROVED},
    {NID_secp256k1, SHA512_DIGEST_LENGTH, BORINGSSL_FIPS_NOT_APPROVED},
};

class ECDH_ServiceIndicatorTest
    : public bssl::TestWithNoErrors<ECDHTestVector> {};
...
static const struct KDFTestVector {
  ...
  const int expect_approved;
    ...
    {EVP_md5, kTLSOutput_md, BORINGSSL_FIPS_APPROVED},
    {EVP_sha1, kTLSOutput_sha1, BORINGSSL_FIPS_APPROVED},
    {EVP_md5_sha1, kTLSOutput_mdsha1, BORINGSSL_FIPS_APPROVED},
    {EVP_sha224, kTLSOutput_sha224, BORINGSSL_FIPS_NOT_APPROVED},
    {EVP_sha256, kTLSOutput_sha256, BORINGSSL_FIPS_APPROVED},
    {EVP_sha384, kTLSOutput_sha384, BORINGSSL_FIPS_APPROVED},
    {EVP_sha512, kTLSOutput_sha512, BORINGSSL_FIPS_APPROVED},
};

class KDF_ServiceIndicatorTest : public bssl::TestWithNoErrors<KDFTestVector> {
};
...
TEST(ServiceIndicatorTest, BasicTest) {
  ...
  // instead calling |FIPS_service_indicator_after_call| This test also ensures
  // that the counter gets incremented once, i.e. it was locked through the
  // internal calls.
  counter_before = FIPS_service_indicator_after_call();
  EXPECT_NE(counter_before, 0);
...
TEST(ServiceIndicatorTest, AESECB) {
  ...
  for (size_t j = 0; j < sizeof(kPlaintext) / AES_BLOCK_SIZE; j++) {
    CALL_SERVICE_AND_CHECK_APPROVED(
        approved,
        AES_ecb_encrypt(&kPlaintext[j * AES_BLOCK_SIZE],
                        &output[j * AES_BLOCK_SIZE], &aes_key, AES_ENCRYPT));
    EXPECT_EQ(approved, BORINGSSL_FIPS_APPROVED);
  }
  ...
  for (size_t j = 0; j < sizeof(kPlaintext) / AES_BLOCK_SIZE; j++) {
    CALL_SERVICE_AND_CHECK_APPROVED(
        approved,
        AES_ecb_encrypt(&kAESECBCiphertext[j * AES_BLOCK_SIZE],
                        &output[j * AES_BLOCK_SIZE], &aes_key, AES_DECRYPT));
    EXPECT_EQ(approved, BORINGSSL_FIPS_APPROVED);
  }
  ...
  for (size_t j = 0; j < sizeof(kPlaintext) / AES_BLOCK_SIZE; j++) {
    CALL_SERVICE_AND_CHECK_APPROVED(
        approved,
        AES_ecb_encrypt(&kAESECBCiphertext_192[j * AES_BLOCK_SIZE],
                        &output[j * AES_BLOCK_SIZE], &aes_key, AES_DECRYPT));
    EXPECT_EQ(approved, BORINGSSL_FIPS_APPROVED);
  }
  EXPECT_EQ(Bytes(kPlaintext), Bytes(output, sizeof(kPlaintext)));
  ...
  for (size_t j = 0; j < sizeof(kPlaintext) / AES_BLOCK_SIZE; j++) {
    CALL_SERVICE_AND_CHECK_APPROVED(
        approved,
        AES_ecb_encrypt(&kAESECBCiphertext_256[j * AES_BLOCK_SIZE],
                        &output[j * AES_BLOCK_SIZE], &aes_key, AES_DECRYPT));
    EXPECT_EQ(approved, BORINGSSL_FIPS_APPROVED);
  }
  EXPECT_EQ(Bytes(kPlaintext), Bytes(output, sizeof(kPlaintext)));
...
TEST(ServiceIndicatorTest, FFDH) {
  ...
  ASSERT_EQ(CALL_SERVICE_AND_CHECK_APPROVED(
                approved,
                DH_compute_key_padded(dh_out, ffdhe2048_value.get(), dh.get())),
...
// |BORINGSSL_FIPS_APPROVED|, but the direct calls to
