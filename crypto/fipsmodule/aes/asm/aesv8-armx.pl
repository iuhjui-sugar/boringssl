...
$code.=<<___;
	...
	//
	// This function uses a counter in one 32-bit lane. Ideally the vmov.32
	// lines would write to $dat1 and $dat2 directly, but that trips this
	// bug. Update $ivec and copy to the final register as a workaround.
	//
