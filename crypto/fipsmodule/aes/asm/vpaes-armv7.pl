...
# expands to an ADD or SUB or the pc register to find a label. That immediate
...
vpaes_encrypt_key_to_bsaes:
	...
	add	r3, r2, .Lk_sr+0x10-.Lk_mc_forward
	add	r11, r2, .Lk_opt-.Lk_mc_forward		@ Input to _vpaes_schedule_transform.
