...
int boringssl_fips_self_test(
  ...
  static const BN_ULONG kFFDHE2048PrivateKeyData[] = {
      TOBN(0x187be36b, 0xd38a4fa1), TOBN(0x0a152f39, 0x6458f3b8),
      TOBN(0x0570187e, 0xc422eeb7), TOBN(0x00000001, 0x91173f2a),
  };

  const uint8_t kDHOutput[32] = {
      0x7b, 0x53, 0x24, 0xe0, 0x45, 0x76, 0x90, 0x7f, 0x1e, 0x35, 0xee,
      0xf6, 0x94, 0x91, 0x25, 0xb0, 0xf1, 0xb0, 0xe5, 0x8a, 0x31, 0xfe,
      0xf0, 0xdf, 0x22, 0x0e, 0x1a, 0xcc, 0x44, 0xd8, 0x00,
  ...
  BIGNUM ffdhe2048_p, ffdhe2048_q, ffdhe2048_g, ffdhe2048_value, ffdhe2048_priv;
  BN_init(&ffdhe2048_p);
  BN_init(&ffdhe2048_q);
  BN_init(&ffdhe2048_g);
  BN_init(&ffdhe2048_value);
  BN_init(&ffdhe2048_priv);
  ...
  if (!dh ||
      !BN_copy(&ffdhe2048_q, &ffdhe2048_p) ||
      ...
      !DH_compute_key_hashed(dh, dh_out, &dh_out_len, sizeof(dh_out),
                             &ffdhe2048_value, EVP_sha256()) ||
      dh_out_len != sizeof(dh_out) ||
      !check_test(kDHOutput, dh_out, dh_out_len, "FFC DH")) {
