...
// These defines will make more sense once we integrate a drop-in replacement
// field arithmetic functions in assembly. For reference, see implementation in
// https://github.com/awslabs/aws-lc/blob/main/crypto/fipsmodule/ec/p384.c#L71-L137
...
static void p384_point_double(p384_felem x_out,
  ...
  // if Fiat-crypto implementation of felem_add and felem_sub is used.
