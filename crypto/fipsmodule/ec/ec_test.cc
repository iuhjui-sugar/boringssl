...
TEST(ECTest, HashToCurve) {
  ...
  static const HashToCurveTest kTests[] = {
      ...
      // the |ec_hash_to_curve_p521_xmd_sha512_sswu_ref_for_testing| due to a
      // bug in the reference implementation. See discussion in
      // |hash_to_field2|. We expose and test this implementation to check our
      // consistency with the rest of the reference implementation.
      ...
      // The above test vectors with the expectations update to compute
