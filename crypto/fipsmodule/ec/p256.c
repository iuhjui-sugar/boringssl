...
static uint64_t mulx_u64(uint64_t a, uint64_t b, uint64_t *high) {
  return _mulx_u64((unsigned __int64)a, (unsigned __int64)b, (unsigned __int64*)high);
}

static uint64_t addcarryx_u64(uint8_t c, uint64_t a, uint64_t b, uint64_t *low) {
  return _addcarryx_u64(c, (unsigned __int64)a, (unsigned __int64)b, (unsigned __int64*)low);
}

static uint64_t subborrow_u64(uint8_t c, uint64_t a, uint64_t b, uint64_t *low) {
  return _subborrow_u64(c, (unsigned __int64)a, (unsigned __int64)b, (unsigned __int64*)low);
}
