...
static void fe_mul(uint32_t out[8], const uint32_t in1[8], const uint32_t in2[8]) {
  ...
  { uint32_t x78; _addcarryx_u32(0x0, x76, x55, &x78);
  ...
  { uint32_t _1; uint8_t x104 = _addcarryx_u32(0x0, x33, x81, &_1);
  ...
  { uint32_t x176; _addcarryx_u32(0x0, x174, x153, &x176);
  ...
  { uint32_t _2; uint8_t x229 = _addcarryx_u32(0x0, x179, x206, &_2);
  ...
  { uint32_t x301; _addcarryx_u32(0x0, x299, x278, &x301);
  ...
  { uint32_t _3; uint8_t x354 = _addcarryx_u32(0x0, x304, x331, &_3);
  ...
  { uint32_t x426; _addcarryx_u32(0x0, x424, x403, &x426);
  ...
  { uint32_t _4; uint8_t x479 = _addcarryx_u32(0x0, x429, x456, &_4);
  ...
  { uint32_t x551; _addcarryx_u32(0x0, x549, x528, &x551);
  ...
  { uint32_t _5; uint8_t x604 = _addcarryx_u32(0x0, x554, x581, &_5);
  ...
  { uint32_t x676; _addcarryx_u32(0x0, x674, x653, &x676);
  ...
  { uint32_t _6; uint8_t x729 = _addcarryx_u32(0x0, x679, x706, &_6);
  ...
  { uint32_t x801; _addcarryx_u32(0x0, x799, x778, &x801);
  ...
  { uint32_t _7; uint8_t x854 = _addcarryx_u32(0x0, x804, x831, &_7);
  ...
  { uint32_t x926; _addcarryx_u32(0x0, x924, x903, &x926);
  ...
  { uint32_t _8; uint8_t x979 = _addcarryx_u32(0x0, x929, x956, &_8);
  ...
  { uint32_t _9; uint8_t x1031 = _subborrow_u32(x1028, x1004, 0x0, &_9);
...
static void fe_sub(uint32_t out[8], const uint32_t in1[8], const uint32_t in2[8]) {
  ...
  {uint32_t x31; uint8_t x32 = _subborrow_u32(0x0, x3, x17, &x31);
  {uint32_t x34; uint8_t x35 = _subborrow_u32(x32, x5, x19, &x34);
  {uint32_t x37; uint8_t x38 = _subborrow_u32(x35, x7, x21, &x37);
  {uint32_t x40; uint8_t x41 = _subborrow_u32(x38, x9, x23, &x40);
  {uint32_t x43; uint8_t x44 = _subborrow_u32(x41, x11, x25, &x43);
  {uint32_t x46; uint8_t x47 = _subborrow_u32(x44, x13, x27, &x46);
  {uint32_t x49; uint8_t x50 = _subborrow_u32(x47, x15, x29, &x49);
  {uint32_t x52; uint8_t x53 = _subborrow_u32(x50, x14, x28, &x52);
  {uint32_t x54 = cmovznz_u32(x53, 0x0, 0xffffffff);
  {uint32_t x56; uint8_t x57 = _addcarryx_u32(0x0, x31, (x54 & 0xffffffff), &x56);
  {uint32_t x59; uint8_t x60 = _addcarryx_u32(x57, x34, (x54 & 0xffffffff), &x59);
  {uint32_t x62; uint8_t x63 = _addcarryx_u32(x60, x37, (x54 & 0xffffffff), &x62);
  {uint32_t x65; uint8_t x66 = _addcarryx_u32(x63, x40, 0x0, &x65);
  {uint32_t x68; uint8_t x69 = _addcarryx_u32(x66, x43, 0x0, &x68);
  {uint32_t x71; uint8_t x72 = _addcarryx_u32(x69, x46, 0x0, &x71);
  {uint32_t x74; uint8_t x75 = _addcarryx_u32(x72, x49, ((uint8_t)x54 & 0x1), &x74);
  {uint32_t x77; _addcarryx_u32(x75, x52, (x54 & 0xffffffff), &x77);
  out[0] = x56;
  out[1] = x59;
  out[2] = x62;
  out[3] = x65;
...
static void fe_opp(uint32_t out[8], const uint32_t in1[8]) {
  ...
  {uint32_t x15; uint8_t x16 = _subborrow_u32(0x0, 0x0, x1, &x15);
  {uint32_t x18; uint8_t x19 = _subborrow_u32(x16, 0x0, x3, &x18);
  {uint32_t x21; uint8_t x22 = _subborrow_u32(x19, 0x0, x5, &x21);
  {uint32_t x24; uint8_t x25 = _subborrow_u32(x22, 0x0, x7, &x24);
  {uint32_t x27; uint8_t x28 = _subborrow_u32(x25, 0x0, x9, &x27);
  {uint32_t x30; uint8_t x31 = _subborrow_u32(x28, 0x0, x11, &x30);
  {uint32_t x33; uint8_t x34 = _subborrow_u32(x31, 0x0, x13, &x33);
  {uint32_t x36; uint8_t x37 = _subborrow_u32(x34, 0x0, x12, &x36);
  {uint32_t x38 = cmovznz_u32(x37, 0x0, 0xffffffff);
  {uint32_t x40; uint8_t x41 = _addcarryx_u32(0x0, x15, (x38 & 0xffffffff), &x40);
  {uint32_t x43; uint8_t x44 = _addcarryx_u32(x41, x18, (x38 & 0xffffffff), &x43);
  {uint32_t x46; uint8_t x47 = _addcarryx_u32(x44, x21, (x38 & 0xffffffff), &x46);
  {uint32_t x49; uint8_t x50 = _addcarryx_u32(x47, x24, 0x0, &x49);
  {uint32_t x52; uint8_t x53 = _addcarryx_u32(x50, x27, 0x0, &x52);
  {uint32_t x55; uint8_t x56 = _addcarryx_u32(x53, x30, 0x0, &x55);
  {uint32_t x58; uint8_t x59 = _addcarryx_u32(x56, x33, ((uint8_t)x38 & 0x1), &x58);
  {uint32_t x61; _addcarryx_u32(x59, x36, (x38 & 0xffffffff), &x61);
  out[0] = x40;
  out[1] = x43;
  out[2] = x46;
  out[3] = x49;
