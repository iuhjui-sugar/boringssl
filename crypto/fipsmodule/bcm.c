...
#define BORINGSSL_FIPS_BREAK_AES_CBC_VALUE 0
#else
#define BORINGSSL_FIPS_BREAK_AES_CBC_VALUE 0xff
#endif

#define BORINGSSL_FIPS_MAYBE_BREAK_TEST(test, value) (value ^ BORINGSSL_FIPS_BREAK_##test##_VALUE)
...
static void BORINGSSL_bcm_power_on_self_test(void) {
  ...
  static const uint8_t kAESCBCCiphertext[64] = {
      ...
      BORINGSSL_FIPS_MAYBE_BREAK_TEST(AES_CBC, 0x35),
  };
