...
static void BORINGSSL_bcm_power_on_self_test(void) {
  ...
  /* 3DES Decryption KAT */
  DES_cblock des_iv2 = {"BCMDESIV"};
  DES_ede3_cbc_encrypt(kDESCiphertext, output, sizeof(kDESCiphertext), &des1, &des2,
                       &des3, &des_iv2, DES_DECRYPT);
  if (!check_test(kPlaintext, output, sizeof(kPlaintext),
                  "3DES Decryption KAT")) {
    goto err;
  }
