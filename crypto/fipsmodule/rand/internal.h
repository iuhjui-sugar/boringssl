...
// TODO(bbe) Android apparently does have getentropy()? We remain
// concerned about the possibility of a lack of kernel support.
#define OPENSSL_RAND_URANDOM
#elif defined(OPENSSL_IOS)
// Unlike MacOS, IOS hides away getentropy() from you.
// arc4random() (chacha) is there seeded and stirred from system entropy
#define OPENSSL_RAND_ARC4RANDOM
// SecRandomCopyBytes is also there but adds a -framework Security dependency to
// libcrypto
