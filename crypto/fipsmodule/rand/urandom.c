...
// On Android, check a system property to decide whether to set |extra_getrandom_flags_for_seed|
// otherwise they will default to zero.  If ro.oem_boringcrypto_hwrand is true then
// |extra_getrandom_flags_for_seed| will be set to GRND_RANDOM, causing all random data to
