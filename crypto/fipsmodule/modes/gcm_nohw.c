...
// This file implements a constant-time implementation of GHASH based on the
// notes in https://bearssl.org/constanttime.html#ghash-for-gcm, as well as the
// reduction algorithm described in
// https://crypto.stanford.edu/RealWorldCrypto/slides/gueron.pdf.
//
// Unlike the BearSSL notes, we use uint128_t in the 64-bit implementation. Our
// primary compilers (clang, clang-cl, and gcc) all support it.
