...
var kats = map[string]string{
	...
	"ECDSA-verify": "304402206780c5fc70275e2c7061a0e7877bb174deadeb9887027f3fa83654158ba7f50c02202d36e5799790bfbe2183d33e96f3c51f6a232f2a24488c8e5f64c37ea2cf0529",
...
func main() {
	if len(os.Args) == 2 && os.Args[1] == "--list-tests" {
	...
	if len(os.Args) != 3 || kats[os.Args[2]] == "" {
		fmt.Fprintln(os.Stderr, "Usage: ", os.Args[0], "<binary path> <test to break> > output")
