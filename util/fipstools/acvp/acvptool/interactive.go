...
func runInteractive(server *acvp.Server, config Config) {
	...
	// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.8
	env.variables["vendors"] = ServerObjectSet{
		env:  env,
		name: "vendors",
		searchKeys: map[string][]acvp.Relation{
			// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.8.1
	...
	env.variables["persons"] = ServerObjectSet{
		...
		name: "persons",
		searchKeys: map[string][]acvp.Relation{
			// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.10.1
	...
	// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.12
	env.variables["oes"] = ServerObjectSet{
		env:  env,
		name: "oes",
		searchKeys: map[string][]acvp.Relation{
			// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.12.1
			"name": []acvp.Relation{acvp.Equals, acvp.StartsWith, acvp.EndsWith, acvp.Contains},
		},
		resultType: reflect.TypeOf(&acvp.OperationalEnvironment{}),
	}
	// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.13
	...
	// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.14
	...
	// https://pages.nist.gov/ACVP/draft-fussell-acvp-spec.html#rfc.section.11.15
