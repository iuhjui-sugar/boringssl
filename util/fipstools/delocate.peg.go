...
func (p *Asm) Init() {
	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l354:
				add(ruleInstructionName, position343)
			}
			return true
		l342:
		...
		func() bool {
			...
			l362:
				add(ruleInstructionArg, position359)
			}
			return true
		l358:
		...
		func() bool {
			...
			l375:
				add(ruleTOCRefHigh, position368)
			}
			return true
		l367:
		...
		func() bool {
			position385, tokenIndex385 := position, tokenIndex
			{
				...
				position++
				add(ruleIndirectionIndicator, position386)
			}
			return true
		l385:
		...
		func() bool {
			...
			l389:
				...
				add(ruleRegisterOrConstant, position388)
			}
			return true
		l387:
		...
		func() bool {
			...
			l440:
				...
				position++
				add(ruleBaseIndexScale, position434)
			}
			return true
		l433:
		...
		func() bool {
			...
			l502:
				...
				position++
				add(ruleSegmentRegister, position501)
			}
			return true
		l500:
